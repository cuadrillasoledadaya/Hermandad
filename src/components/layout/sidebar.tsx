...
import { X, Home, Users, Wallet, Share2, Settings, Receipt, Church, LogOut, Shield, ScrollText } from 'lucide-react';
                    ...
                    <div className="mt-auto p-4 border-t bg-slate-50/50">
                        <div className="px-3 py-3 bg-white border border-slate-200 rounded-xl shadow-sm mb-3">
                            ...
                            <div className="flex items-center gap-2 mt-1">
                                ...
                                <p className="text-xs font-bold text-blue-600 mt-2 text-center">v1.1.59 ✅</p>
                            </div>
                        </div>
                        <button
                            onClick={() => {
