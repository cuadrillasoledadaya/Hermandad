        ...
        <Table className="min-w-[1000px] border-collapse bg-white">
            <TableHeader>
                <TableRow className="bg-slate-50">
                    <TableHead className="w-[180px] max-w-[200px] sticky left-0 bg-white z-20 font-bold border-r-2 border-slate-200 shadow-[2px_0_5px_rgba(0,0,0,0.05)] px-4">
                        Hermano
                    </TableHead>
                    {MONTHS.map((month) => (
                    ...
                    {canPay && (
                        <TableHead className="text-center font-bold bg-white sm:sticky right-0 z-20 sm:border-l-2 border-slate-200 sm:shadow-[-2px_0_5px_rgba(0,0,0,0.05)]">
                            Acción
                        </TableHead>
                    )}
                </TableRow>
            ...
            <TableBody>
                {hermanos.length === 0 ? (
                    ...
                    hermanos.map((hermano) => (
                        <TableRow key={hermano.id} className="hover:bg-muted/50 transition-colors">
                            <TableCell className="font-semibold sticky left-0 bg-white z-10 border-r-2 border-slate-200 shadow-[2px_0_5px_rgba(0,0,0,0.05)] whitespace-nowrap px-4 py-3">
                            ...
                            {canPay && (
                                <TableCell className="text-center p-0 sm:sticky right-0 bg-white z-10 sm:border-l-2 border-slate-200 sm:shadow-[-2px_0_5px_rgba(0,0,0,0.05)]">
